...
return [
    'invalid_grant'         => 'The grant_type is not specified as autht oauth. Change the grant type in your request to "authtooauth".',
    'access_denied'         => 'The Auth token you specified has already been used to generate OAuth tokens. \n Enter a different Authtoken in your request.',
    ...
    'invalid_auth_token'    => 'The auth token you specified is wrong. Ensure that your Auth token is correct and that it hasn\'t already been converted to OAuth.',
